...
function createMap(){
    ...
    var point = new BMap.Point(116.511381,39.966771);//定义一个中心点坐标
...
//标注点数组
var markerArr = [{title:"我的位置",content:"我常出现的位置",point:"116.509953|39.9672",isOpen:0,icon:{w:23,h:22,l:46,t:0,x:8,lb:12}}
];
//创建marker
function addMarker(){
